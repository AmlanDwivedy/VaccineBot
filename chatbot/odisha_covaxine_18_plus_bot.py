...
def extract_availability_data(response):
    ...
    if len(message) > 0:
        ...
        send_telegram_message("No slots available now. Last checked at {}. You can join the Odisha Covishield 18+ channel https://t.me/odisha_covishild_18_plus".format(now.strftime("%H:%m")))
